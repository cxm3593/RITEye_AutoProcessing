...
if (All_mode == True):
	for i in range(1, 25):
		...
		dest_file_path = "./"+process_modelName+ version_str + file_postfix
		...
		subprocess.call([blender_path, '-b', process_modelName + version_str + file_postfix, '-P', 'AutoScript_ExternalLink.py', '--',
						"--model_id", process_modelName])
		shutil.move(dest_file_path, "./AutoGenerated/"+process_modelName+ version_str + file_postfix)
